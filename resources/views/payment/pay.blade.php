...
@section('content')
    <form action="{{ route('createPayment') }}" method="POST" class="container">
        ...
        <input type="text" class="orderId" name="orderId" value="{{ $order->orderId }}">
        <input type="text" class="paypalID" name="paypalID" hidden>
        <input type="text" class="userId" name="userId" value="{{ Auth::user()->id }}" hidden>
        <div class="row container mt-5">
            <div class="col-4">
                <div class="mb-3">
                    ...
                    <input type="text" class="userName" value="{{ Auth::user()->name }}">
                </div>
            ...
            <div class="col-4">
                <div class="mb-3">
                    ...
                    <input type="text" class="itemName" name="itemName" value="{{ $order->itemName }}"
                        class="form-control">
                </div>
            ...
            <div class="col-4">
                <div class="mb-3">
                    ...
                    <br>
                    <input type="text" class="totalPrice" name="totalPrice" value="{{ $order->totalPrice }}"
                        class="form-control">
